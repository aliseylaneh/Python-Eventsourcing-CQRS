...
async def reserve(sku: SKU, reserve_stock: InventoryReserveStock,
                  command: ReserveStockCommand = Depends(get_reserve_stock_command)) -> InventoryResponse:
    """
...
async def create(inventory: CreateInventory,
                 command: CreateInventoryCommand = Depends(get_create_inventory_command)) -> InventoryResponse:
    """
...
async def get(sku: SKU, command: GetInventoryQuery = Depends(get_inventory_query)) -> InventoryResponse:
